...
import "./WebmoneyCredit.sol";

contract WebmoneyCreditPreSale {
    WebmoneyCredit public token;
    ...
    function WebmoneyCreditPreSale(
        WebmoneyCredit _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = WebmoneyCredit(_token);
